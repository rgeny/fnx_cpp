...
size_t	NotCaseString::find_last_not_of	(const NotCaseString & str
									,size_t pos) const
{
	return (this->find_last_not_of(str.c_str(), pos, str.size()));
}

size_t	NotCaseString::find_last_not_of	(const char * s
									,size_t pos) const
{
...
size_t	NotCaseString::find_last_not_of	(char c
									,size_t pos) const
{
